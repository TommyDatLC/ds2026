...
class FileTransferStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Upload = channel.stream_unary(
                '/file_transfer.FileTransfer/Upload',
...
def add_FileTransferServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'file_transfer.FileTransfer', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('file_transfer.FileTransfer', rpc_method_handlers)
